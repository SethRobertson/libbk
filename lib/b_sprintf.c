#if !defined(lint)
static const char libbk__copyright[] __attribute__((unused)) = "Copyright © 2008-2019";
static const char libbk__contact[] __attribute__((unused)) = "<projectbaka@baka.org>";
#endif /* not lint */
/*
 * ++Copyright BAKA++
 *
 * Copyright © 2008-2019 The Authors. All rights reserved.
 *
 ...
 * with other, very similiar, functions just fine. With this one, however,
 * there seems to be trouble with both the function prototype and the
