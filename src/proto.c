...
static char libbk__rcsid[] = "$Id: proto.c,v 1.14 2001/11/14 20:46:02 seth Exp $";
...
main(int argc, char **argv, char **envp)
{
  ...
  while ((c = poptGetNextOpt(optCon)) >= 0)
  {
    ...
    {
    case 'd':
      bk_error_config(B, BK_GENERAL_ERROR(B), 0, stderr, 0, BK_ERR_DEBUG, BK_ERROR_COFNIG_FH);	// Enable output of all error logs
