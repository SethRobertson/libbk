...
UNUSED static const char libbk__rcsid[] = "$Id: shmcat.c,v 1.1 2006/08/14 16:46:56 seth Exp $";
...
static int proginit(bk_s B, struct program_config *pc)
{
  ...
  if (!(pc->pc_bsi = bk_shmipc_create(B, pc->pc_filename, pc->pc_timeout, pc->pc_timeout, pc->pc_poll, pc->pc_length, 0700, BK_FLAG_ISSET(pc->pc_flags, PC_RDONLY)?BK_SHMIPC_RDONLY:BK_SHMIPC_WRONLY|BK_SHMIPC_WRWAITFORRD)))
  {
